...
if (!message.member.hasPermission("ADMINISTRATOR"))  if(!message.member.roles.has("740254376215707738")) return message.channel.send(`Bu Komutu Kullanmaya Yetkin Yetmiyor!`);
  ...
  member.addRole('740216195902603285')  // LADİES ROL
   member.addRole('740216206081917020') // LADİES2 Rolün ID
   member.addRole('722385691597602868')
...
.setDescription(`${kullanıcı} **Kişisine <@&740216195902603285>,<@&740216206081917020>, rolleri verildi.**`)
.setColor('RANDOM')
